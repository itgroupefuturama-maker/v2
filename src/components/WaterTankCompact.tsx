...
export function WaterTankCompact({ currentVolume, maxCapacity }: WaterTankCompactProps) {
  ...
  return (
    <div className="relative w-full h-80 border-4 border-gray-3000 dark:border-gray-600 rounded-3xl overflow-hidden bg-gray-50 dark:bg-gray-900 flex flex-col justify-end shadow-lg">
      <div
